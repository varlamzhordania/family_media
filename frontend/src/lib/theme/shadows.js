...
export const createShadow = (color) => {
    ...
    const prepShadows = {}
    result.forEach((shadow, index) => {
        prepShadows[index] = shadow
    })
    return prepShadows

};

export const createCustomShadow = (color) => {
    ...
    return {
        ...
        dialog: `-40px 40px 80px -8px ${alpha("#000", 0.24)}`,
